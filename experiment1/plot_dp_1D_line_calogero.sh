...
gnuplot -e "set terminal png size 1536,1024 enhanced fontscale 2; 
			...
			'dpCastin$N2-$a2.dat' w points pt 6 ps 2 linecolor 'black' title 'Calogero: N = $N2, a = $a2', 
			 'mf$mf/dpX$N4-$a4.dat' w lines lw 4 title 'N = $N4, a = $a4',
			'dpCastin$N4-$a4.dat' w points pt 3 ps 2 linecolor 'black' title 'Calogero: N = $N4, a = $a4', 
			 'mf$mf/dpX$N10-$a10.dat' w lines lw 4 title 'N = $N10, a = $a10',
			'dpCastin$N10-$a10.dat' w points pt 2 ps 2 linecolor 'black' title 'Calogero: N = $N10, a = $a10', 
			 'mf$mf/dpX$N20-$a20.dat' w lines lw 4 title 'N = $N20, a = $a20',
			'dpCastin$N20-$a20.dat' w points pt 1 ps 2 linecolor 'black' title 'Calogero: N = $N20, a = $a20', 
			"
