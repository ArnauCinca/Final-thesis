...
gnuplot -e "set terminal png size 800,800; set output 'dp$mf.png'; 
			...
			N=$N100; a=$a100;
			plot 'mf$mf/dp$N2-$a2.dat' w linespoints pt 7 ps 0, 
				 'mf$mf/dp$N4-$a4.dat' w linespoints pt 7 ps 0,
				 'mf$mf/dp$N6-$a6.dat' w linespoints pt 7 ps 0,
				 'mf$mf/dp$N10-$a10.dat' w linespoints pt 7 ps 0,
				 'mf$mf/dp$N20-$a20.dat' w linespoints pt 7 ps 0,
				 'mf$mf/dp$N100-$a100.dat' w linespoints pt 7 ps 0, 
				 McGuire(x)"
firefox dp$mf.png
